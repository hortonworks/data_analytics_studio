...
public class DataCastAnalyzer implements QueryAnalyzer {
  ...
  private static final String DATA_CAST_MSG = "The query attempts to cast %s.%s from %s to %s. Casting is usually computationally expensive. You should considering creating a new columns in %s.";
