...
public class TestArtifactSourceType {
  ...
  public void testCreateAllTypes() {
    ...
    HiveQueryService hiveQueryService = mock(HiveQueryService.class);
    QueryDetailsService queryDetailsService = mock(QueryDetailsService.class);
    Injector injector = Guice.createInjector(new Module() {
      ...
      public void configure(Binder binder) {
        ...
        binder.bind(DagInfoDao.class).toInstance(mock(DagInfoDao.class));
        binder.bind(VertexInfoDao.class).toInstance(mock(VertexInfoDao.class));
      }
    });
