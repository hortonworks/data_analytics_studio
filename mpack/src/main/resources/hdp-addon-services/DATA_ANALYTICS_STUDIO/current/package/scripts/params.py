...
data_analytics_studio_webapp_jvm_opts = default("/configurations/data_analytics_studio-env/webapp_jvm_opts", "")
data_analytics_studio_ep_jvm_opts = default("/configurations/data_analytics_studio-env/ep_jvm_opts", "")
...
data_analytics_studio_database_jdbc_url = format("jdbc:postgresql://{data_analytics_studio_database_host}:{data_analytics_studio_database_port}/{data_analytics_studio_database_username}")
...
not_managed_resources = get_not_managed_resources() if 'not_managed_hdfs_path_list' in config['clusterLevelParams'] else ''
