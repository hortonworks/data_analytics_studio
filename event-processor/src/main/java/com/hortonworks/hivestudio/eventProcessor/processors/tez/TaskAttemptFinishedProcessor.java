...
public class TaskAttemptFinishedProcessor extends TezEventProcessor {

  @Inject
  public TaskAttemptFinishedProcessor() {
  }
  ...
  protected TezEventType[] validEvents() {
    return new TezEventType[]{TezEventType.TASK_ATTEMPT_FINISHED};
  }
}
