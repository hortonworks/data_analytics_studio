...
import com.hortonworks.hivestudio.eventProcessor.resources.AboutResource;
import io.dropwizard.setup.Environment;

public class RestResourcesClassRegistry extends ApplicationRegistry<Class<?>, EventProcessorConfiguration> {

  public RestResourcesClassRegistry(EventProcessorConfiguration configuration, Environment environment) {
