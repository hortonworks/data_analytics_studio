 ...
 */
public class FilterRegistry extends ApplicationRegistry<FilterDefinition, EventProcessorConfiguration> {
  public FilterRegistry(EventProcessorConfiguration configuration, Environment environment) {
