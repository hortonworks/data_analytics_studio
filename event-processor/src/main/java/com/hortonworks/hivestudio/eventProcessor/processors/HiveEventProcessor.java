...
public abstract class HiveEventProcessor implements EventProcessor<HiveHookEventProto> {
  ...
  protected abstract ProcessingStatus processValidEvent(HiveHSEvent event);
  protected abstract HiveEventType[] validEvents();
