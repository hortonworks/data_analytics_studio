...
public class VertexConfigureDoneProcessor extends TezEventProcessor {

  @Inject
  public VertexConfigureDoneProcessor() {
  }
  ...
  protected ProcessingStatus processValidEvent(TezHSEvent event, Path filePath) {
    ...
    return new ProcessingStatus(
      ProcessingStatus.Status.SUCCESS, Optional.empty()
    );
  }

  @Override
  protected TezEventType[] validEvents() {
    return new TezEventType[]{TezEventType.VERTEX_CONFIGURATION_DONE};
  }
}
