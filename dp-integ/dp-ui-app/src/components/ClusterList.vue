      ...
      .then((response) => {
        ...
        for (var i = 0; i < clusters.length; ++i) {
          ...
          function parseResults(responses, cobj, cluster) {
              try {
                let dasInfo = responses[0].data;
                let hostname = dasInfo[0].hosts[0];
                let hostProps = dasInfo[0].properties.filter(a => {return a.type == 'data_analytics_studio-webapp-properties'})[0].properties;
