...
import com.hortonworks.hivestudio.hive.HiveJdbcConnectionDelegate;
...
public class ConnectionSupplier implements ContextSupplier<ConnectionDelegate> {
  ...
  @Override
  public ConnectionDelegate get(HiveContext context, Configuration configuration) {
    log.debug("Creating Connection delegate");
