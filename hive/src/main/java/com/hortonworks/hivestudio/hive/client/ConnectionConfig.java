...
public class ConnectionConfig {
  ...
  public Connect createConnectMessage() {
    return new Connect(hiveContext.getUsername(), password, jdbcUrl);
  }

  public Connect createConnectMessage(Integer jobId) {
    return new Connect(jobId, hiveContext.getUsername(), password, jdbcUrl);
  }
