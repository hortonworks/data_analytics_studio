...
import com.hortonworks.hivestudio.hive.utils.ambari.AmbariApi;
...
public class ATSParserFactory {
  ...
  public ATSParserFactory(HiveContext context, AmbariApi ambariApi) {
  ...
  public String getATSUrl() {
    return ambariApi.getTimelineServerUrl();
  }
}
