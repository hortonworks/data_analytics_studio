...
/**
 * JDBI repository for File
 */
public class FileRepository extends JdbiRepository<File, Integer, FileDao> {
  @Inject
  public FileRepository(FileDao dao) {
    super(dao);
  }

  @Override
  public Optional<File> findOne(Integer id) {
  ...
  public Collection<File> findAllByOwner(String username) {
