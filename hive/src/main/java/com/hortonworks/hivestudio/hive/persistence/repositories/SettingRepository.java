...
/**
 * JDBI repository for Setting
 */
public class SettingRepository extends JdbiRepository<Setting, Integer, SettingDao> {
  @Inject
  ...
  @Override
  public Optional<Setting> findOne(Integer id) {
  ...
  public Collection<Setting> findAllByOwner(String username) {
    return this.getDao().findAllByOwner(username);
  }

  public Optional<Setting> findByKeyAndOwner(String key, String owner) {
    return getDao().findAllByOwnerAndKey(owner, key);
  }
}
