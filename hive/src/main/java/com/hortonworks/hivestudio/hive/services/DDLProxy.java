...
public class DDLProxy {
  ...
  public Set<DatabaseResponse> getDatabases(HiveContext hiveContext, CreationSource creationSource) {
    Set<DatabaseInfo> infos = getDatabaseInfos(hiveContext, creationSource);
...
//    }
  ...
  public Set<DatabaseInfo> getDatabaseInfos(HiveContext hiveContext, CreationSource creationSource) {
    List<Database> databases = metaStoreService.getAllByCreationSource(creationSource);
