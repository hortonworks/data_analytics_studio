...
public interface AsyncJobRunner {
  ...
  void cancelJob(Integer jobId, HiveContext hiveContext);

  Optional<NonPersistentCursor> getCursor(Integer jobId, HiveContext hiveContext) throws TimeoutException;

  Optional<NonPersistentCursor> resetAndGetCursor(Integer jobId, HiveContext context) throws TimeoutException;

  Optional<Failure> getError(Integer jobId, HiveContext hiveContext) throws TimeoutException;
