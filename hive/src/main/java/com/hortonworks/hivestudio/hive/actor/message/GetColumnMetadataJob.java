...
public class GetColumnMetadataJob extends HiveJob {
  ...
  public GetColumnMetadataJob(HiveContext hiveContext,
                              String schemaPattern, String tablePattern, String columnPattern) {
    super(Type.SYNC, hiveContext);
  ...
  public GetColumnMetadataJob(HiveContext hiveContext,
    ...
    this(hiveContext, "*", tablePattern, columnPattern);
  }

  public GetColumnMetadataJob(HiveContext hiveContext,
                              String columnPattern) {
    this(hiveContext, "*", "*", columnPattern);
  }
