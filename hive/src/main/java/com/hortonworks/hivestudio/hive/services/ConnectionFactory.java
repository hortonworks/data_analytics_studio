...
public class ConnectionFactory {
  ...
  public String appendSessionParams(HiveContext context, String jdbcUrl) {
    String sessionParams = appConfiguration.getOrThrow(Constants.HIVE_SESSION_PARAMS);
  ...
  private String getConnectFromCustom() {
    ...
    String hiveSessionParams = appConfiguration.getOrThrow(Constants.HIVE_SESSION_PARAMS);
