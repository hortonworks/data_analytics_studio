...
public class AboutServiceTest {
  ...
  public void setup() {
    ...
    dasConf = mock(Configuration.class);
    when(dasConf.get(any(), any())).thenReturn("dummy_value");
    ...
    aboutService = new AboutService(proxy, resourceUtils, configuration, connectionFactory, dasConf, appPropRepoProvider, appAuthentication);
  }
