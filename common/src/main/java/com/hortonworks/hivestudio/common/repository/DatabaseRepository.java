...
public class DatabaseRepository extends JdbiRepository<Database, Integer, DatabaseDao> {
  ...
  public List<Database> getAllByCreationSourceAndNotDropped(CreationSource creationSource) {
    return dao.findAllByCreationSourceAndNotDropped(creationSource.name());
  }
