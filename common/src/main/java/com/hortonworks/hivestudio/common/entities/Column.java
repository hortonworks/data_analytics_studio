...
@Data
public class Column implements Identifiable<Integer> {
  ...
  private ParsedColumnType columnType = ParsedColumnType.NORMAL;
  ...
  private Integer columnPosition = -1;
  ...
  // Sad stuff, jdbi enum mapper is not directly usable with SQLObject, hence these methods.
