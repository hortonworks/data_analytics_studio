...
public class HdfsService {
  ...
  protected HdfsApiSupplier hdfsApiSupplier;

  /**
   * Constructor
   * @param configuration View Context instance
   */
  @Inject
  public HdfsService(Configuration configuration, HdfsApiSupplier hdfsApiSupplier) {
