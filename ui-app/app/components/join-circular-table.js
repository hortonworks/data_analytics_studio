    ...
    (function (classes) {
      ...
      svg.selectAll("g.node")
        ...
        .attr("class", function (d, index) {
          return 'parent-' + d.name.split('.')[1] + ' node';
        })
      ...
      svg.selectAll("g.arc")
        ...
        .attr("transform", (d) => {
          let t = d3.selectAll('text.' + 'parent-' + d.groupName)[0][0].getAttribute('table-transform');
          return t;
        })
        .text((d) => {
          ...
          if(d.groupName.length > lenOfTableName && (x < 0 && y<0)) {
            return d.groupName.substr(0, lenOfTableName)+"...";
          }
          return d.groupName;
        });
    })(allColumns);
