...
export default ApplicationAdapter.extend({
  ...
  // TODO : We can remove this now. As we will get the query in the job object itself
  getQuery(jobId) {
    let queryUrl = this.urlForFindRecord(jobId, 'job') + "/query";
    return Ember.$.get(queryUrl);
  },
