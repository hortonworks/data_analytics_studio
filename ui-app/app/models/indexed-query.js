...
export default AbstractModel.extend({
  ...
  databasesUsed: DS.attr("object"),
  status: DS.attr("string"),
  progress: 0,

  cpuTime: DS.attr('number'),
  physicalMemory: DS.attr('number'),
  virtualMemory: DS.attr('number'),
  dataRead: DS.attr('number'),
  dataWritten: DS.attr('number'),

  usedCBO: DS.attr('string'),
