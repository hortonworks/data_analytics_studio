...
export default MultiTableController.extend({
  ...
  viewData1: Ember.computed("model.query1", function () {
    var model = this.get("model.query1"),
    ...
    vertices = this.get('model.query1.firstObject.dag.vertices') || [];
    entities = {};
    ...
    console.log(this.get('visibleColumns'));
    return {
      vertices: vertices,
      edges: dag.get('edges'),
  ...
  viewData2: Ember.computed("model.query2", function () {
    var model = this.get("model.query2"),
        dag, vertices, entities;
    ...
    vertices = this.get('model.query2.firstObject.dag.vertices') || [];
    entities = {};
